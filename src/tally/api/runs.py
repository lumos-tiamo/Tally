...
from tally.orchestration.agent import Agent, AgentSpec
from tally.orchestration.hitl import (
    Decision,
    InterruptRequest,
    InterruptResponse,
)
from tally.store import AgentDef, AgentStore, RunState
...
class RunManager:
    ...
    def _execute(self, handle: RunHandle, agent_def: AgentDef,
        ...
        from tally.models.router import Router  # noqa: PLC0415 - import cycle
