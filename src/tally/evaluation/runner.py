...
from tally.context.slots import DEFAULT_POLICIES, SlotName, SlotPolicy
from tally.evaluation.harness import CaseRunResult, run_metrics_from
...
def make_case_runner(ctx: RunnerContext) -> Callable[[GroundTruthCase, str], CaseRunResult]:
    ...
    if ctx.arm.deterministic_workflow:
        from tally.evaluation.workflow_arm import make_workflow_runner
