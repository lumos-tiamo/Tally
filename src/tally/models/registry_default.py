...
keeps `tally` runnable on a machine with zero keys (fake provider only),
...
from tally.models.quota import QuotaLimit
from tally.models.router import DEFAULT_LIMITS, Registry
